...
# Programa que calcule el promedio de calificaciones de una alunma y muestre la boleta de calificaciones
...
label_promedio = tk.Label(ventana, text="0.00", width=10, bg="lightgray")
label_promedio.grid(row=i+0, column=4, padx=5)
fila.append(label_promedio)
filas.append(fila)

label_promedio = tk.Label(ventana, text="0.00", width=10, bg="lightgray")
label_promedio.grid(row=i+1, column=4, padx=5)
fila.append(label_promedio)
filas.append(fila)
